...
public class MobilePhoneTestSuite {
    ...
    public void testDefaultBehaviourOfTestDouble() {
        Assertions.assertFalse(myPhone.needsCharging()); //zwróci False bo wartością domyślną dla prymitywnego typu boolean jest false
        Assertions.assertEquals(0.0, myPhone.getFreeStorage()); //dla typu double: domyślną wartością jest 0.0
    }
    @Test
