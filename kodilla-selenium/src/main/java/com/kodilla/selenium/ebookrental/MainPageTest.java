package com.kodilla.selenium.ebookrental;
...
public class MainPageTest {
    public static void main(String[] args) {
        ...
        //funkcjonalność edycji historii wypozyczeń
        //wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("rents page")));
        WebElement editHistory = driver.findElement(By.cssSelector("#rent-41724 > div.rents-list__rent__actions.list__item__actions > button.edit-btn.btn--small.btn.btn--warning"));
        editHistory.click();
